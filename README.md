...
<p>
  ...
  separate tool needed, and the **Add** page offers a game's fixes right after a Fetch. See
  [Achievements](#achievements) and [Fixes after a Fetch](#fixes-after-a-fetch) below.
